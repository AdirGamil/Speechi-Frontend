...
export interface I18nStrings {
  ...
  // Auth errors
  authErrorFirstNameRequired: string;
  authErrorLastNameRequired: string;
  authErrorNameMin: string;
  authErrorEmailRequired: string;
  authErrorEmailInvalid: string;
  authErrorPasswordRequired: string;
  authErrorPasswordMin: string;
  authErrorConfirmPasswordRequired: string;
  authErrorPasswordsNoMatch: string;
  authErrorUserNotFound: string;
  authErrorEmailExists: string;
...
const I18N: Record<UiLang, I18nStrings> = {
  en: {
    ...
    authSecurityNote: "Your password is encrypted and your data is secure.",
    authBenefitsTitle: "Free account benefits:",
    authBenefit1: "Analyze up to 5 meetings per day",
    authBenefit2: "Cloud-synced history across devices",
    ...
    authErrorLastNameRequired: "Last name is required",
    authErrorNameMin: "Must be at least 2 characters",
    ...
    authErrorPasswordMin: "Password must be at least 6 characters",
    authErrorConfirmPasswordRequired: "Please confirm your password",
    authErrorPasswordsNoMatch: "Passwords do not match",
    ...
    authErrorGeneral: "Something went wrong. Please try again.",
    // Usage
  ...
  he: {
    ...
    authFirstNamePlaceholder: "ישראל",
    authLastNamePlaceholder: "ישראלי",
    authEmailPlaceholder: "you@example.com",
    authPasswordPlaceholder: "לפחות 6 תווים",
    authConfirmPasswordPlaceholder: "אשר את הסיסמה",
    ...
    authSecurityNote: "הסיסמה שלך מוצפנת והנתונים שלך מאובטחים.",
    authBenefitsTitle: "יתרונות חשבון חינם:",
    authBenefit1: "נתח עד 5 פגישות ביום",
    authBenefit2: "היסטוריה מסונכרנת בענן",
    ...
    authErrorFirstNameRequired: "שם פרטי הוא שדה חובה",
    authErrorLastNameRequired: "שם משפחה הוא שדה חובה",
    authErrorNameMin: "חייב להכיל לפחות 2 תווים",
    authErrorEmailRequired: "אימייל הוא שדה חובה",
    authErrorEmailInvalid: "אנא הכנס אימייל תקין",
    authErrorPasswordRequired: "סיסמה היא שדה חובה",
    authErrorPasswordMin: "הסיסמה חייבת להכיל לפחות 6 תווים",
    authErrorConfirmPasswordRequired: "אנא אשר את הסיסמה",
    authErrorPasswordsNoMatch: "הסיסמאות אינן תואמות",
    authErrorUserNotFound: "לא נמצא חשבון עם אימייל זה",
    authErrorEmailExists: "חשבון עם אימייל זה כבר קיים",
    authErrorInvalidCredentials: "אימייל או סיסמה שגויים",
    authErrorGeneral: "משהו השתבש. אנא נסה שוב.",
    // Usage
  ...
  fr: {
    ...
    authSecurityNote: "Votre mot de passe est crypté et vos données sont sécurisées.",
    authBenefitsTitle: "Avantages du compte gratuit :",
    authBenefit1: "Analysez jusqu'à 5 réunions par jour",
    authBenefit2: "Historique synchronisé dans le cloud",
    ...
    authErrorFirstNameRequired: "Le prénom est requis",
    authErrorLastNameRequired: "Le nom est requis",
    authErrorNameMin: "Doit contenir au moins 2 caractères",
    authErrorEmailRequired: "L'email est requis",
    authErrorEmailInvalid: "Veuillez entrer un email valide",
    authErrorPasswordRequired: "Le mot de passe est requis",
    authErrorPasswordMin: "Le mot de passe doit contenir au moins 6 caractères",
    authErrorConfirmPasswordRequired: "Veuillez confirmer votre mot de passe",
    authErrorPasswordsNoMatch: "Les mots de passe ne correspondent pas",
    authErrorUserNotFound: "Aucun compte trouvé avec cet email",
    authErrorEmailExists: "Un compte avec cet email existe déjà",
    authErrorInvalidCredentials: "Email ou mot de passe invalide",
    authErrorGeneral: "Une erreur s'est produite. Veuillez réessayer.",
    // Usage
  ...
  es: {
    ...
    authSecurityNote: "Tu contraseña está encriptada y tus datos están seguros.",
    authBenefitsTitle: "Beneficios de la cuenta gratuita:",
    authBenefit1: "Analiza hasta 5 reuniones por día",
    authBenefit2: "Historial sincronizado en la nube",
    ...
    authErrorFirstNameRequired: "El nombre es obligatorio",
    authErrorLastNameRequired: "El apellido es obligatorio",
    authErrorNameMin: "Debe tener al menos 2 caracteres",
    authErrorEmailRequired: "El email es obligatorio",
    authErrorEmailInvalid: "Por favor ingresa un email válido",
    authErrorPasswordRequired: "La contraseña es obligatoria",
    authErrorPasswordMin: "La contraseña debe tener al menos 6 caracteres",
    authErrorConfirmPasswordRequired: "Por favor confirma tu contraseña",
    authErrorPasswordsNoMatch: "Las contraseñas no coinciden",
    authErrorUserNotFound: "No se encontró cuenta con este email",
    authErrorEmailExists: "Ya existe una cuenta con este email",
    authErrorInvalidCredentials: "Email o contraseña inválidos",
    authErrorGeneral: "Algo salió mal. Por favor intenta de nuevo.",
    // Usage
  ...
  ar: {
    ...
    authFirstNamePlaceholder: "محمد",
    authLastNamePlaceholder: "أحمد",
    authEmailPlaceholder: "you@example.com",
    authPasswordPlaceholder: "6 أحرف على الأقل",
    authConfirmPasswordPlaceholder: "أكد كلمة المرور",
    ...
    authSecurityNote: "كلمة المرور مشفرة وبياناتك آمنة.",
    authBenefitsTitle: "مزايا الحساب المجاني:",
    authBenefit1: "حلل حتى 5 اجتماعات يومياً",
    authBenefit2: "سجل متزامن على السحابة",
    ...
    authErrorFirstNameRequired: "الاسم الأول مطلوب",
    authErrorLastNameRequired: "اسم العائلة مطلوب",
    authErrorNameMin: "يجب أن يحتوي على حرفين على الأقل",
    authErrorEmailRequired: "البريد الإلكتروني مطلوب",
    authErrorEmailInvalid: "يرجى إدخال بريد إلكتروني صالح",
    authErrorPasswordRequired: "كلمة المرور مطلوبة",
    authErrorPasswordMin: "يجب أن تحتوي كلمة المرور على 6 أحرف على الأقل",
    authErrorConfirmPasswordRequired: "يرجى تأكيد كلمة المرور",
    authErrorPasswordsNoMatch: "كلمات المرور غير متطابقة",
    authErrorUserNotFound: "لم يتم العثور على حساب بهذا البريد",
    authErrorEmailExists: "حساب بهذا البريد موجود بالفعل",
    authErrorInvalidCredentials: "البريد الإلكتروني أو كلمة المرور غير صالحة",
    authErrorGeneral: "حدث خطأ. يرجى المحاولة مرة أخرى.",
    // Usage
